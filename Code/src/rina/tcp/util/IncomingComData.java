...
public class IncomingComData extends Thread{

	private Log log = LogFactory.getLog(IncomingComData.class);
	...
	public  IncomingComData( TCPFlow tcpListeningFlow,TCPFlowAllocated tcpFlowAllocated)
	{
	...
	public void run()
	{
		...
		{	
			try {
				...
				new IncomingComHandlerData(clientTCPFlow, this.tcpFlowAllocated).start();
